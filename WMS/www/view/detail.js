...
app.controller('DetailCtrl',
        ...
        function (ENV,$scope, $stateParams, $state, $http, $timeout, $ionicLoading, $ionicPopup, WebApiService) {
            ...
            strUri="/api/event/action/update/done?JobNo="+$scope.detail.JobNo+"&JobLineItemNo="+$scope.detail.JobLineItemNo+"&LineItemNo="+$scope.detail.LineItemNo+"&DoneFlag="+'N'+"&Remark="+$scope.Update.remark+ "&ContainerNo"+$scope.Update.ContainerNo ;
                  ...
                  // sessionStorage.getItem('strPhoneNumber')
                    ...
                    strUri="/api/event/action/update/done?JobNo="+$scope.detail.JobNo+"&JobLineItemNo="+$scope.detail.JobLineItemNo+"&LineItemNo="+$scope.detail.LineItemNo+"&DoneFlag="+'Y'+"&DoneDatetime"+currentDate+"&Remark="+$scope.Update.remark+"&PhoneNumber="+sessionStorage.getItem('strPhoneNumber')+ "&ContainerNo"+$scope.Update.ContainerNo ;
                }
